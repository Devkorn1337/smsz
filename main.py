...
for i in range(num):
	...
	print(Colorate.Horizontal(Colors.rainbow,"SEND|SMS2|"))
	...
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS29|"))
	threading.Thread(target=api30).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS30|"))
	threading.Thread(target=api31).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS31|"))
	threading.Thread(target=api32).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS32|"))
	threading.Thread(target=api33).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS33|"))
	threading.Thread(target=api34).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS34|"))
	threading.Thread(target=api35).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS35|"))
	threading.Thread(target=api36).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS36|"))
	threading.Thread(target=api37).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS37|"))
	threading.Thread(target=api38).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS38|"))
	threading.Thread(target=api39).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS39|"))
	threading.Thread(target=api40).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS40|"))
	threading.Thread(target=api41).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS41|"))
	threading.Thread(target=api42).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS42|"))
	threading.Thread(target=api43).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS43|"))
	threading.Thread(target=api44).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS44|"))
	threading.Thread(target=api45).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS45|"))
	threading.Thread(target=api46).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS46|"))
	threading.Thread(target=api47).start()
	print(Colorate.Horizontal(Colors.rainbow,"SEND|SMS47|"))
	threading.Thread(target=api48).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS48|"))
	threading.Thread(target=api49).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS49|"))
	threading.Thread(target=api50).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS50|"))
	threading.Thread(target=api51).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS51|"))
	threading.Thread(target=api52).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS52|"))
	threading.Thread(target=api53).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS53|"))
	threading.Thread(target=api54).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS54|"))
	threading.Thread(target=api55).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS55|"))
	threading.Thread(target=api56).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS56|"))
	threading.Thread(target=api57).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS57|"))
	threading.Thread(target=api58).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS58|"))
	threading.Thread(target=api59).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS59|"))
	threading.Thread(target=api60).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS60|"))
	threading.Thread(target=api61).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS61|"))
	threading.Thread(target=api62).start()
	print (Colorate.Horizontal(Colors.yellow_to_green,"SEND|SMS|"))
